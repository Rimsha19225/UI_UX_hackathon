  ...
  return (
    <div className="bg-[#F0F0F0] w-[100%] h-[499px] pt-20">
      <div className="w-[87%] h-[20vh] bg-[#000000] rounded-2xl ml-[6.3rem] flex items-center pl-16 mt-[-9rem]">
        <div className="integral text-white text-[32px] w-[35%] font-bold leading-none">STAY UPTO DATE ABOUT OUR LATEST OFFERS</div>
        <div>
          ...
          <button className="satoshi text-black bg-white w-[25rem] rounded-full p-[0.75rem] ml-[20rem] hover:bg-[#e3e2e2]">Subscribe to Newsletter</button>
        </div>
      </div>
        <div className="flex gap-[8.2rem] w-[87%] ml-[6.3rem] mt-14">
              <div className="w-[22%]">
                  <h3 className="integral font-[700] text-[#000000] text-[33.45px] leading-[40.15px] mb-6">SHOP.CO</h3>
                  <p className="satoshi font-[400] mb-6 hover:text-[#908f8f]">We have clothes that suits your style and which you’re proud to wear. From women to men.</p>
        ...
        <div className="satoshi flex mt-8 ml-[6.3rem]">
          <div className="hover:text-[#908f8f]">Shop.co © 2000-2023, All Rights Reserved</div>
          <div className="flex gap-4 ml-[47rem]">
