...
const NavBar = () => {
  ...
  return (
    <div className="navbody w-full bg-[#ffffff] fixed top-7 md:top-9 z-50 pb-[0.5rem] border-b-[1px]">
      <div className="w-[90%] h-[1rem] sm:h-[1rem] md:h-[5rem] 2xl:w-[1500px] mx-auto flex justify-around 2xl-[w-1500px]">
          <div className='integral pl-2 md:pl-0 font-bold text-[25px] sm:text-[30px] md:text-[32px] w-20 mt-[2rem] sm:mt-[2.7rem] md:mt-[2.2rem] ml-10  cursor-pointer'>SHOP.CO</div>
        ...
        <div className="absolute sm:hidden top-20 right-[0.01rem] w-screen h-screen bg-gray-400 text-black flex flex-col items-center gap-4 py-3 rounded opaci">
          <div className='satoshi w-[15rem] gap-[10rem] mt-[1rem] mr-[10rem]'>
            <div className="link flex gap-1 hover:font-semibold p-2 m-2 rounded hover:text-white">
              <Link href={"#"} 
              className="satoshi font-semibold dropdown-button border-none cursor-pointer border-r-[5px]">Shop </Link>
              <div className='mt-2'> <Image src={dropdown} alt="drop" className=""/> </div>
            </div >
            <div className='p-2 m-2 rounded hover:text-white'><Link href={"#"} className='satoshi link font-semibold'>On Sale</Link></div>
            <div className='p-2 m-2 rounded hover:text-white'><Link href={"/new_Arival"} className='satoshi link font-semibold'>New Arrivals</Link></div>
            <div className='p-2 m-2 rounded hover:text-white'><Link href={"#"} className='satoshi link font-semibold'>Brands</Link></div>
          </div>
        </div>
      )}
    </div>
