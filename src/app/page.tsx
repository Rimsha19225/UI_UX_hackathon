      ...
      <div className="w-[90%] 2xl:w-[1500px] mx-auto flex justify-around">
        <div>
          <div className="mr-20 mb-[35px]">
            ...
            <button className="card mt-[1.5rem] p-2 rounded-full bg-[#000000] text-[#ffffff] w-36 hover:w-[9.5rem]">Shop Now</button>
        ...
        <div className="flex relative w-[40rem]">
          ...
          <Image src={hero} alt="hero_section_image" className="absolute w-[100%] h-[80vh]"/>
          <Image src={star_2} alt="hero_section_image" className="shake absolute right-5 top-24 w-[6rem]"/>
        </div>
      </div>
      <div className='bg-[#000000] flex justify-center items-center gap-[8rem] h-[13vh] mt-[4.3rem]'>
