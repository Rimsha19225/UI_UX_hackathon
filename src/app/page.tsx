...
export default function Home() {
  return (
    <div className="relative w-full bg-[#F2F0F1] h-auto xl:h-[80vh] mt-[8.6rem] overflow-x-hidden">
      ...
      <div className='bg-[#000000] grid grid-cols-3 sm:grid-cols-5 gap-[2rem] justify-center items-center sm:gap-[8rem] h-auto pt-[2rem] sm:pt-[1.7rem] pb-[2rem] sm:pb-[1.7rem] pr-[3rem] sm:pr-[5.5rem] pl-[3rem] sm:pl-[5.5rem] mt-[40rem] sm:mt-[4rem]'>
